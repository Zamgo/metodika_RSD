...
Schválení změny během výstavby (ZBV) v hodnotě nad 50 mil. Kč

## Kdy se spouští

Workflow se spouští, když [[Zhotovitel|zhotovitel]] předkládá koncept ZBV v hodnotě nad 50 mil. Kč ke schválení.
...
| 9 | Vložení elektronického podpisu - TDS | TDS | 1 den | Zajištění podpisů dle směrnice ŘSD. |
| 10 | Vložení elektronického podpisu - Správce stavby | SpSt | 1 den | Zajištění podpisů dle směrnice ŘSD. |
| 11 | Vložení elektronického podpisu - Objednatel | Objednatel | 3 dny | Zajištění podpisů dle směrnice ŘSD. |
| 12 | Vložení elektronického podpisu - Objednatel (2. podpis) | Objednatel | 1 den | Zajištění podpisů dle směrnice ŘSD. |
| 13 | Vložení elektronického podpisu - Objednatel (3. podpis) | Objednatel | 1 den | Zajištění podpisů dle směrnice ŘSD. |
| 14 | Administrace + Upload DSS | Proconom | 5 dní | Pracovník společnosti Proconom nahraje podepsané ZBV do AspeHub. |
